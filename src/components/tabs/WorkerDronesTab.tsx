...
export function WorkerDronesTab({ state, onAssign, onOptimise, onBack }: WorkerDronesTabProps) {
        ...
        <Section>
          ...
          <div className="worker-job-list">
            {jobs.map((job) => {
              ...
              return (
                <article key={job.id} className="worker-job-card" data-guide={`worker-${job.id}`}>
