...
import { idleWorkers, isStationUnlocked } from '../../game/catalog'
import {
  ...
  return (
    <section className="panel">
      <header className="panel-header">
        <h2>Core</h2>
        <p>Train attributes and equip Signal Cores.</p>
      </header>

      <div className="sub-tabs" role="tablist" aria-label="Core sections">
        <button
          type="button"
          role="tab"
      ...
      {sub === 'attributes' ? (
        ...
        <>
          <p className="muted">
            ...
            {carryOver ? 'Persist across prestige.' : 'Wipe on prestige until Null Signal.'}
          </p>
          {equipBlocked ? (
            <p className="notice-warn">Null Signal — equipping blocked.</p>
          ) : null}
