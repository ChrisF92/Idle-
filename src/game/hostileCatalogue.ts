...
export const HOSTILE_DEFS: readonly HostileDef[] = [
  entry({ id: 'void-mite', name: 'Void Mite', firstContactWave: 1, shape: 'triangle' }),
  entry({ id: 'needle-skitter', name: 'Needle Skitter', firstContactWave: 30, shape: 'triangle' }),
  entry({ id: 'brood-splitter', name: 'Brood Splitter', firstContactWave: 85, shape: 'circle' }),
  entry({ id: 'carapace-walker', name: 'Carapace Walker', firstContactWave: 115, shape: 'square' }),
  entry({ id: 'cinder-diver', name: 'Cinder Diver', firstContactWave: 140, shape: 'circle' }),
  entry({ id: 'phase-wisp', name: 'Phase Wisp', firstContactWave: 175, shape: 'diamond' }),
  entry({ id: 'bulwark', name: 'Bulwark', firstContactWave: 190, shape: 'square' }),
  entry({ id: 'iron-ram', name: 'Iron Ram', firstContactWave: 260, shape: 'square' }),
  entry({ id: 'veil-sniper', name: 'Veil Sniper', firstContactWave: 290, shape: 'diamond' }),
  entry({ id: 'mortar-cyst', name: 'Mortar Cyst', firstContactWave: 325, shape: 'hex' }),
  entry({ id: 'bastion-husk', name: 'Bastion Husk', firstContactWave: 365, shape: 'square' }),
  entry({ id: 'mirror-shade', name: 'Mirror Shade', firstContactWave: 395, shape: 'diamond' }),
  entry({ id: 'ashen-chorister', name: 'Ashen Chorister', firstContactWave: 440, shape: 'hex' }),
  entry({ id: 'suppressor-node', name: 'Suppressor Node', firstContactWave: 470, shape: 'hex' }),
  entry({ id: 'prism-warder', name: 'Prism Warder', firstContactWave: 515, shape: 'hex' }),
  entry({ id: 'cantor', name: 'Cantor', firstContactWave: 565, shape: 'hex' }),
  entry({
    id: 'resonance-vessel',
  ...
  entry({ id: 'reclaimer', name: 'Reclaimer', firstContactWave: 690, shape: 'square' }),
  entry({
    id: 'breach-engine',
    name: 'Breach Engine',
  ...
  entry({ id: 'null-shepherd', name: 'Null Shepherd', firstContactWave: 865, shape: 'diamond' }),
  entry({
    id: 'crowned-husk',
    name: 'Crowned Husk',
