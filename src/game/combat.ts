 ...
 * teaches Plate. S9–S24 grow slower so Furnace→Challenges is a bump, not a cliff.
 * S25+ (Choir Crown approach) steepens hull, damage, and density toward W300.
 */
export const ENEMY_EARLY_SECTOR = 8
/** Mid band ends at W240. Choir Crown approach (W250+) uses the late curve. */
export const ENEMY_MID_SECTOR = 24
...
/** S25+ (W250+). Steeper than mid so Challenges→Choir Crown is a real finale. */
